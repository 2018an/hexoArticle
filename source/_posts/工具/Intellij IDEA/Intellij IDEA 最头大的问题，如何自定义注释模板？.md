...
![](img/18-10-23-85720861.jpg)

另外，就是设置模板使用的场景，如以下所示，点击 Define 链接，设置类模板只能在 Java 语言下使用。

![](img/18-10-23-35553716.jpg)

方法注释和类注释配置一致，配置示例如下：

![](img/18-10-23-59877084.jpg)

![](img/18-10-23-24832650.jpg)
